...
export const DeleteModal: React.FC<DeleteModalProps> = ({ isOpen, onClose, onDelete, isLoading, chatTitle }) => {
        ...
        >
            ...
            >
                <div className='flex justify-between items-center mb-4'>
                    <h2 className='text-xl font-semibold'>Eliminar chat</h2>
                ...
                <div className='mb-4'>
                    <p>
                        ¿Estás seguro de que deseas eliminar el chat <span className='font-semibold'>{chatTitle || 'Sin título'}</span>?
                    </p>
                ...
                <div className='flex justify-end gap-2 mt-4'>
                    ...
                    <Button color='danger' onPress={onDelete} disabled={isLoading} isLoading={isLoading}>
                        Eliminar
                    </Button>
                </div>
            </div>
